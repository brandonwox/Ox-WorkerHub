...
interface Props {
  visible: boolean;
  onClose: () => void;
  /** Unassigned jobcards (the Work Requests pool). */
  cards: Jobcard[];
...
/**
 * The Work Requests pool expanded into a large month calendar: each open
 * request sits on its target date, colored by priority. Purely a viewing
 * tool — nothing here touches crew schedules; placing requests on crews still
 * happens from the board.
 */
        ...
        <View style={styles.card}>
          <View style={styles.header}>
            <View style={styles.headerLeft}>
              ...
              <Text style={styles.hint}>
                ...
                aren&apos;t affected; place work from the board.
              </Text>
            </View>
          ...
          {shownCount < cards.length && (
            <Text style={styles.offMonthNote}>
              ...
              {cards.length - shownCount === 1 ? '' : 's'} dated outside this
              month.
            </Text>
          )}
